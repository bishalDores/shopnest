...
export default function NavUI({ cartItemsCount }: Props) {
  ...
  return (
    <>
      <MaterialNav className="mx-auto px-4 py-2" fullWidth>
        <div className="flex items-center justify-between text-blue-gray-900 container mx-auto">
          <Link href="/" className="mr-4 cursor-pointer py-1.5 lg:ml-2 font-semibold uppercase">
            shopnest
          </Link>
          ...
          <div className="hidden lg:flex gap-2 items-center">
            ...
            {loggedIn ? (
              ...
              <>
                ...
                <Link className="bg-black text-white px-4 py-1 rounded" href="/auth/signup">
                  Sign up
                </Link>
              </>
            )}
          ...
          <div className="lg:hidden flex items-center space-x-2">
            ...
            <IconButton variant="text" color="blue-gray" className="lg:hidden" onClick={() => setOpen(!open)}>
              {open ? (
