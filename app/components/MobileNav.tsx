...
import { Drawer, Typography, IconButton, List, ListItem, ListItemPrefix } from "@material-tailwind/react";
...
export default function MobileNav({ open, onClose, menuItems }: Props) {
        ...
        <List>
          ...
          {loggedIn ? (
            ...
            <div className="flex items-center">
              ...
              <Link className="bg-blue-500 text-white px-4 py-1 rounded flex-1 text-center" href="/auth/signup">
                Sign up
              </Link>
            </div>
          )}
